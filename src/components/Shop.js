...
function Shop() {
    ...
    useEffect(() => {
        axios('https://restcountries.com/v2/all').then(data => {
            setProducts([
                {id: 1, brand: 'SYOSS', description: 'Шампунь SYOSS Color с Цветком Камелии для окрашенных и тонированных волос 440 мл', model: 'Шампунь SYOSS Color',   price: 100.00, selected: false, imgSrc: 'https://content.rozetka.com.ua/goods/images/big_tile/258469002.jpg'},
                ...
                {id: 12, brand: 'SYOSS', description: 'Питательный шампунь GLISS Oil Nutritive для сухих и поврежденных волос 400 мл', model: 'Питательный шампунь GLISS',price: 105.00, selected: false, imgSrc: 'https://content.rozetka.com.ua/goods/images/big_tile/166779303.jpg'}
            ])
        });
    }, [])
